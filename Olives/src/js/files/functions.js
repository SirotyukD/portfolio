...
export function menuInit() {
	if (document.querySelector(".icon-menu")) {
		document.addEventListener("click", function (e) {
			if ((bodyLockStatus && e.target.closest('.icon-menu')) || (bodyLockStatus && e.target.closest('.icon-menu'))) {
				bodyLockToggle();
...
export function menuCloseOnClickLink() {

	//закриття меню при кліку на лінку
	if (document.querySelector(".icon-menu")) {
		document.addEventListener("click", function (e) {
			const target = e.target;
			const link = target.classList.contains('menu__link');
			const btn = target.classList.contains('header__btn');

			const menu_is_active = document.documentElement.classList.contains("menu-open");
			//якщо відкрите меню і натиснули на елемент меню - закрити
			if ((btn || link) && menu_is_active) {
				bodyLockToggle();
...
export function loadDsdPlayer() {

	if (document.querySelector("[data-dsd-player]")) {

		const videosOnPage = document.querySelectorAll('[data-dsd-player]');

		for (var i = 0; i < videosOnPage.length; i++) {
			const videoWrap = videosOnPage[i];

			videoWrap.insertAdjacentHTML('beforeend', '<div class="dsd-player__controls" dsd-controls> <button class="dsd-player__btn" dsd-play> <svg viewBox="0 0 24 24" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g /><g ><path d="M3.9,18.9V5.1c0-1.6,1.7-2.6,3-1.8l12,6.9c1.4,0.8,1.4,2.9,0,3.7l-12,6.9C5.6,21.5,3.9,20.5,3.9,18.9z"/></g></svg> </button><button class="dsd-player__btn" dsd-stop><svg baseProfile="tiny" height="24px" id="Layer_1" version="1.2" viewBox="0 0 24 24" width="24px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g><path d="M16,6H8C6.9,6,6,6.9,6,8v8c0,1.1,0.9,2,2,2h8c1.1,0,2-0.9,2-2V8C18,6.9,17.1,6,16,6z"/></g></svg></button><input type="range" class="dsd-player__peogressbar" dsd-progressbar min="0" max="100" step="0.1" value="0" /> <span class="dsd-player__timestamp" dsd-timestamp >00:00</span> <div class="dsd-player__volume" dsd-volume> <svg fill="#000" height="48" viewBox="0 0 48 48" width="48" xmlns="http://www.w3.org/2000/svg"> <path d="M6 18v12h8l10 10V8L14 18H6zm27 6c0-3.53-2.04-6.58-5-8.05v16.11c2.96-1.48 5-4.53 5-8.06zM28 6.46v4.13c5.78 1.72 10 7.07 10 13.41s-4.22 11.69-10 13.41v4.13c8.01-1.82 14-8.97 14-17.54S36.01 8.28 28 6.46z" /> <path d="M0 0h48v48H0z" fill="none" /></svg> <input class="dsd-player__volume-input" dsd-volume-input type="range"> </div> <div class="dsd-player__fullscreen" dsd-fullscreen> <svg fill="#000" viewBox="0 0 96 96" xmlns="http://www.w3.org/2000/svg"> <title /> <g> <path d="M30,0H6A5.9966,5.9966,0,0,0,0,6V30a6,6,0,0,0,12,0V12H30A6,6,0,0,0,30,0Z" /> <path d="M90,0H66a6,6,0,0,0,0,12H84V30a6,6,0,0,0,12,0V6A5.9966,5.9966,0,0,0,90,0Z" /> <path d="M30,84H12V66A6,6,0,0,0,0,66V90a5.9966,5.9966,0,0,0,6,6H30a6,6,0,0,0,0-12Z" /> <path d="M90,60a5.9966,5.9966,0,0,0-6,6V84H66a6,6,0,0,0,0,12H90a5.9966,5.9966,0,0,0,6-6V66A5.9966,5.9966,0,0,0,90,60Z" /> </g></svg></div></div></div>')

			const playBtn = videoWrap.querySelector('[dsd-play]');
			const stopBtn = videoWrap.querySelector('[dsd-stop]');
			const video = videoWrap.querySelector('video');
			const progressbar = videoWrap.querySelector('[dsd-progressbar]');
			const timestamp = videoWrap.querySelector('[dsd-timestamp]');
			const volume = videoWrap.querySelector('[dsd-volume-input]');
			const fullscreen = videoWrap.querySelector('[dsd-fullscreen]');
			...
			function updatePlayIcon() {
				if (video.paused) {
					playBtn.innerHTML = '<svg viewBox="0 0 24 24" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g /><g ><path d="M3.9,18.9V5.1c0-1.6,1.7-2.6,3-1.8l12,6.9c1.4,0.8,1.4,2.9,0,3.7l-12,6.9C5.6,21.5,3.9,20.5,3.9,18.9z"/></g></svg>';
					...
					playBtn.innerHTML = '<svg height="24px" viewBox="0 0 24 24" width="24px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M8,6C6.896,6,6,6.896,6,8v8c0,1.104,0.896,2,2,2s2-0.896,2-2V8C10,6.896,9.104,6,8,6z"/><path d="M15,6c-1.104,0-2,0.896-2,2v8c0,1.104,0.896,2,2,2s2-0.896,2-2V8C17,6.896,16.104,6,15,6z"/></svg>';
				}
			}
